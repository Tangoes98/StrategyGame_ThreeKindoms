...
public class ConstructCampAction : UnitBaseConstructAction
{
    ...
    protected override void Update()
    {
        ...
        BuildCamp(_targetPosition);

        Debug.Log("BuildCampAction");
    ...
    void BuildCamp(Vector3 worldPosition)
    {
        Transform campTransform = Instantiate(_campConstructionPrefab, worldPosition, Quaternion.identity);
